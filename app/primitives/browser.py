...
class BrowserManager:
    ...
    async def load_page(self, url: str, timeout: int = None) -> Dict[str, any]:
        """
    ...
    async def find_submit_url(self, page: Page) -> Optional[str]:
        ...
        try:
            ...
            # Strategy 2: Look for submit endpoint in page text/data
            html = await page.content()
            ...
            # Strategy 3: Look in page text for "submit to: URL"
            text = await page.inner_text("body")
    ...
    async def extract_instructions(self, page: Page) -> str:
        ...
        """
        try:
            # Try common selectors for instructions
            selectors = [
                ".instructions",
                "#instructions",
                ".problem",
